...
<body>
    <main>
        ...
        <div class="item item-1">
            <a href="catalog/astra_gtc.html"><img src="img/Opel_AstraGTC.jpg" alt="Opel Astra GTC"></a>
            <div class="item-text">
                <p class="slogan">Спортивная динамичность</p>
                <h3 class="model"><a href="catalog/astra_gtc.html" class="car-pages">Astra GTC</a></h3>
            </div>
        </div>
        <div class="item item-2">
            <a href="catalog/astra_hatchback.html"><img src="img/Opel_Astra_Hatchback.jpg" alt="Opel Astra Hatchback"></a>
            <div class="item-text">
                <p class="slogan">Элегантность и стиль</p>
                <h3 class="model"><a href="catalog/astra_hatchback.html" class="car-pages">Astra Hatchback</a></h3>
            </div>
        </div>
        <div class="item item-3">
            <a href="catalog/Insignia_CT.html"><img src="img/Opel_Insignia_Country_Tourer.jpg" alt="Opel Insignia Country Tourer"></a>
            <div class="item-text">
